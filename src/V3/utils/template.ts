...
export default function template( ...raw: TemplateStringsArray ): DocumentFragment
export default function template( elem: HTML ): DocumentFragment
export default function template( ...raw: TemplateStringsArray|[HTML] ): DocumentFragment {
