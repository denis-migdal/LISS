...
host = HTMLElement, files = {} }) {
    ...
    if (brython) {
        if (!("index.bry" in files)) files['index.bry'] = await _fetchText(`${compo_dir}index.bry`, true);
...
`;
        ...
        if (!("index.js" in files)) files['index.js'] = await _fetchText(`${compo_dir}index.js`, true);
    }
