...
/* harmony export */ });
/* harmony import */ var V3_utils_template__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! V3/utils/template */ "./src/V3/utils/template.ts");
/* harmony import */ var _ContentGenerator__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./ContentGenerator */ "./src/V3/ContentGenerators/ContentGenerator.ts");
/* harmony import */ var V3_utils_encode__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! V3/utils/encode */ "./src/V3/utils/encode.ts");



const regex = /\$\{(.+?)\}/g;
class AutoContentGenerator extends _ContentGenerator__WEBPACK_IMPORTED_MODULE_1__["default"] {
    prepareHTML(html) {
        this.data = null;
        if (typeof html === 'string') {
            this.data = html;
    ...
    fillContent(shadow) {
        ...
        if (this.data !== null) {
            const str = this.data.replace(regex, (_, match)=>{
                ...
                return (0,V3_utils_encode__WEBPACK_IMPORTED_MODULE_2__["default"])(value);
            });
            this.template = (0,V3_utils_template__WEBPACK_IMPORTED_MODULE_0__["default"])(str);
        }
        super.fillContent(shadow);
    /*
        // html magic values could be optimized...
...
/* harmony import */ var V2_types__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! V2/types */ "./src/V2/types.ts");
/* harmony import */ var V2_utils__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! V2/utils */ "./src/V2/utils.ts");
/* harmony import */ var V3_utils_template__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! V3/utils/template */ "./src/V3/utils/template.ts");
/* harmony import */ var V3_utils_style__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! V3/utils/style */ "./src/V3/utils/style.ts");
...
class ContentGenerator {
    ...
    constructor({ html, css = [], shadow = null } = {}){
        this.#shadow = shadow;
        const isReady = (0,V3_utils_ressource__WEBPACK_IMPORTED_MODULE_0__.isRessourceReady)(html) && (0,V3_utils_ressource__WEBPACK_IMPORTED_MODULE_0__.isRessourceReady)(css) && (0,V2_utils__WEBPACK_IMPORTED_MODULE_3__.isDOMContentLoaded)();
        ...
        const whenReady = Promise.all([
            ...
            (0,V2_utils__WEBPACK_IMPORTED_MODULE_3__.whenDOMContentLoaded)()
        ]);
    ...
    template = null;
    prepare(html, css) {
        if (html !== undefined) this.prepareHTML(html);
        if (css !== undefined) this.prepareCSS(css);
    }
    prepareHTML(html) {
        this.template = (0,V3_utils_template__WEBPACK_IMPORTED_MODULE_4__["default"])(html);
    }
    prepareCSS(css) {
        if (!Array.isArray(css)) css = [
            css
        ];
        this.stylesheets = css.map((e)=>(0,V3_utils_style__WEBPACK_IMPORTED_MODULE_5__["default"])(e));
    }
    /*** Generate contents ***/ // fill / generate / init / inject
    fillContent(shadow) {
        this.injectCSS(shadow, this.stylesheets);
        if (this.template !== null) shadow.append(this.template.cloneNode(true));
        customElements.upgrade(shadow);
    }
    generate(host) {
        //TODO: wait parents/children depending on option...     
        ...
        if (host.shadowMode !== V2_types__WEBPACK_IMPORTED_MODULE_2__.ShadowCfg.NONE || target.childNodes.length === 0) target.replaceChildren(content);
        //if( target instanceof ShadowRoot && target.childNodes.length === 0)
        //	target.append( document.createElement('slot') );
        customElements.upgrade(host);
        return target;
    ...
    initShadow(host) {
        const canHaveShadow = (0,V2_utils__WEBPACK_IMPORTED_MODULE_3__.isShadowSupported)(host);
        if (this.#shadow !== null && this.#shadow !== V2_types__WEBPACK_IMPORTED_MODULE_2__.ShadowCfg.NONE && !canHaveShadow) throw new Error(`Host element ${(0,V2_utils__WEBPACK_IMPORTED_MODULE_3__._element2tagname)(host)} does not support ShadowRoot`);
        let mode = this.#shadow;
        if (mode === null) mode = canHaveShadow ? V2_types__WEBPACK_IMPORTED_MODULE_2__.ShadowCfg.OPEN : V2_types__WEBPACK_IMPORTED_MODULE_2__.ShadowCfg.NONE;
        host.shadowMode = mode;
        let target = host;
        if (mode !== V2_types__WEBPACK_IMPORTED_MODULE_2__.ShadowCfg.NONE) target = host.attachShadow({
            mode
        });
        return target;
    }
...
class LISSBase extends HTMLElement {
    ...
    constructor(){
        ...
        if (klass.SHADOW_MODE !== null) {
            this.#content = this.attachShadow({
                mode: klass.SHADOW_MODE
            });
            if (klass.CONTENT_GENERATOR !== null) klass.CONTENT_GENERATOR.fillContent(this.content);
        }
    }
    ...
    get content() {
        if (this.#content === undefined) throw new Error("This custom element doesn't have a ShadowRoot!");
        return this.#content;
    }
}
...
//# sourceMappingURL=data:application/json;charset=utf-8;base64,