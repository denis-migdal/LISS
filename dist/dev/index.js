...
async function importComponentV3(tagname, { cdir = V2_helpers_LISSAuto__WEBPACK_IMPORTED_MODULE_0__.DEFAULT_CDIR } = {}) {
    ...
    // try/catch ?
    const promises = [
        (0,V2_helpers_LISSAuto__WEBPACK_IMPORTED_MODULE_0__._fetchText)(`${compo_dir}index.html`, true),
        (0,V2_helpers_LISSAuto__WEBPACK_IMPORTED_MODULE_0__._fetchText)(`${compo_dir}index.css`, true)
    ];
